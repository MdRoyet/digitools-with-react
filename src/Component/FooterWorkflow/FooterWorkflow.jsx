...
const FooterWorkflow = () => {
  return (
    // The main section with a full-width specific purple gradient background and padding
    <section className="w-full bg-gradient-to-r from-[#712BFD] to-[#A228FF] py-32 px-4 font-manrope">
      <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        {/* Button Group (Explore Products & View Pricing) */}
        <div className="flex flex-col sm:flex-row items-center gap-6 mb-16">
          ...
          {/* Outlined Button with White Border and Text */}
        ...
        {/* Small Footer Text with trial details */}
